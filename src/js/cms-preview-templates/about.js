  ...
  render() {
    ...
    return (
      <div className="ph3 bg-off-white">
          ...
          <div className="flex-ns mhn2-ns mb3">
            <div className="ph2-ns w-50-ns">
              <h3 className="f3 b lh-title mb2">
                {entry.getIn(["data", "mission", "heading"])}
              </h3>
              <p>{entry.getIn(["data", "mission", "text"])}</p>
            </div>
            <div className="ph2-ns w-50-ns">
              <h3 className="f3 b lh-title mb2">
                {entry.getIn(["data", "vision", "heading"])}
              </h3>
        ...
        <div className="mw7 center pt4">
          <h2 className="f2 b lh-title mb3">
            {entry.getIn(["data", "team", "heading"])}
          </h2>
          <div className="flex-ns flex-wrap mhn2-ns mb3">
            {(entry.getIn(["data", "team", "members"]) || []).map(
              (member, i) => (
                <div className="ph2-ns w-50-ns mb4" key={i}>
                  <div className="bg-white br3 pa3 shadow-5">
                    <img
                      src={getAsset(member.get("image"))}
                      alt={member.get("name")}
                      className="db w-100 br3 mb3"
                    />
        ...
        <div className="mw7 center pt4">
          <h2 className="f2 b lh-title mb3">
            {entry.getIn(["data", "principles", "heading"])}
          </h2>
          <div className="flex-ns flex-wrap mhn2-ns">
            {(entry.getIn(["data", "principles", "values"]) || []).map(
              (value, i) => (
                <div className="ph2-ns w-50-ns mb4" key={i}>
        ...
        <div className="mw7 center pt4 pb4">
          <h2 className="f2 b lh-title mb3">
            {entry.getIn(["data", "contact", "heading"])}
          </h2>
          <div className="measure-narrow">
            <p>{entry.getIn(["data", "contact", "text"])}</p>
            <div className="mb3">
              <a
                href={`mailto:${entry.getIn(["data", "contact", "email"])}`}
                className="btn raise"
              >
                Email us
              </a>
